...
def test_fresh_and_upgrade_preflight_are_pinned_to_rc13(tmp_path: Path) -> None:
    for scenario in ("fresh", "upgrade"):
        for tag in ("v0.23.0-rc.9", "v0.23.0-rc.10", "v0.23.0-rc.11"):
            ...
            _assert_failed(result, "acceptance is pinned to v0.23.0-rc.13")
...
<key>YuluReleaseVersion</key><string>0.23.0-rc.13</string>
