...
def test_upgrade_observer_binds_migration_before_and_requires_real_retry_lineage(tmp_path: Path) -> None:
    ...
    try:
        ...
        _private_json(current_preflight, {
            ...
            "status": "passed",
            "scenario": "upgrade",
            "releaseTag": "v0.23.0-rc.11",
            "dmgUrl": "https://github.com/Nowhitestar/Yulu/releases/download/v0.23.0-rc.11/yulu-macos-arm64-v0.23.0-rc.11.dmg",
            "checksumsUrl": "https://github.com/Nowhitestar/Yulu/releases/download/v0.23.0-rc.11/checksums.txt",
            "architecture": "arm64",
        ...
        _private_json(bundle_evidence, {
            ...
            "formalAcceptance": False,
            "status": "matched",
            "release": {"shortVersion": "0.23.0", "releaseVersion": "0.23.0-rc.11"},
