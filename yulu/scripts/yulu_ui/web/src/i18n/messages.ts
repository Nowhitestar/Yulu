...
export const en: Messages = {
  ...
  "settings.transcription.diarization.threshold.help": "Auto mode only. Higher values split into more speakers.",
...
export const zh: Messages = {
  ...
  "settings.transcription.diarization.threshold.help": "仅自动模式使用。数值越高越容易拆成更多说话人。",
