...
export const en: Messages = {
  ...
  "settings.llm.backend.help": "Agent-queue keeps the durable summary queue. Ask Yulu uses the selected local Agent CLI when it needs live conversation.",
  ...
  "settings.llm.capability.agentQueue": "Agent-queue mode; Ask Yulu will auto-detect Codex or Claude Code for live chat.",
  "settings.llm.preset.agentQueue": "Agent-queue (your coding agent)",
  "settings.llm.preset.claude": "Claude CLI",
  "settings.llm.preset.codex": "Codex CLI",
  ...
  "settings.integrations.calendar.sub": "Native Scheduler is always Yulu-owned. Choose which local calendar provider it monitors.",
...
export const zh: Messages = {
  ...
  "settings.llm.backend.help": "Agent-queue 保留可靠的摘要队列；Ask Yulu 需要实时对话时会使用选中的本地 Agent CLI。",
  "settings.llm.backend.aria": "LLM 后端",
  "settings.llm.capability.label": "后端能力",
  "settings.llm.capability.help": "当前摘要后端能否在这台机器上解析并使用。",
  "settings.llm.capability.agentQueue": "Agent-queue 模式；Ask Yulu 会自动检测 Codex 或 Claude Code 做实时对话。",
  ...
  "settings.integrations.calendar.sub": "Native Scheduler 始终由 Yulu 负责；在这里选择它监听的本地日历提供方。",
