...
export const SETTINGS: SettingDef[] = [
  ...
  { path: "audio.output_dir",            category: "audio", label: "录音输出目录", type: "path",    validate: z.string().min(1),           reload: R.restart("audiodaemon") },
  ...
  { path: "transcription.mlx",           category: "transcription", label: "MLX 参数", type: "text", validate: z.record(z.unknown()),      reload: R.restart("sttdaemon") },
