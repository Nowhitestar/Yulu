...
`v0.23.0-rc.20`, after green CI, real fresh-install and `v0.22.2` upgrade checks
...
This pins the intended promotion source; it is not an acceptance decision or
publication authorization. Reuse applicable unchanged capability evidence as
recorded in `docs/phase13-closeout.md`. Do not inspect password stores or copy
